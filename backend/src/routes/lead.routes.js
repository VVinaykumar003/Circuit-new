...
const { createLead, getAllLeads, updateLead, deleteLead, convertLeadToCustomer, bulkDeleteLeads } = require("../controllers/lead.controller");
...
router.post("/:slug/bulk-delete-leads", auth, tenant, bulkDeleteLeads);
router.delete("/:slug/bulk-delete-leads", auth, tenant, bulkDeleteLeads);
