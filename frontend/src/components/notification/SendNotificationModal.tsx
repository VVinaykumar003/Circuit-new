...
export default function SendNotificationModal({
  ...
  return (
    <div className="fixed inset-0 bg-base-content/30 backdrop-blur-sm flex items-center justify-center z-50 px-4">
      <div className="bg-base-100 border-base-300 text-base-content w-full max-w-lg rounded-xl p-5 shadow-xl border space-y-6 animate-in fade-in zoom-in-95 duration-200">
        {/* Header */}
